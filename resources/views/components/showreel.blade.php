...
<div class="my-25" @keydown.esc="show = false">
    ...
    <div ref="target" v-show="show" @fullscreenchange="handle" class="fixed top-0 z-50 w-full h-full bg-white flex items-center p-10">
        <button class="absolute top-0 right-0 py-5 px-10 font-sans text-sm" @click="show = false">Close (ESC)</button>
        <video-player inline-template :autoplay="show">
