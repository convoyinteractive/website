<figure class="{{ $class ?? '' }}">
    <div class="lg:w-10/12 lg:flex items-center justify-between flex-row-reverse mx-auto">
        <blockquote class="block px-6 my-10 lg:w-7/10 font-sans text-3xl xl:text-like-3xl leading-normal font-semibold">
            <p>{{ $component->get('body') }}</p>
        </blockquote>
        <figcaption class="block px-6 my-10 lg:w-3/10 xl:w-2/10">
